...
export function GrainLayout({
  ...
  return (
    ...
    >
      {topNavigation}
      <div className="mx-auto grid h-[calc(100svh-3.5rem)] min-h-0 max-w-[1600px] lg:grid-cols-[minmax(16rem,18.75rem)_minmax(0,1fr)]">
        {sidebar ? (
        ...
        <ScrollArea className="min-h-0 min-w-0" id={documentationScrollAreaId}>
          <main
            id="content"
            className="heyo-docs-enter heyo-docs-enter--content min-h-full min-w-0 px-6 pb-10 pt-10 sm:px-10 lg:px-12 lg:pb-12 lg:pt-12 xl:pb-0"
          >
            {children}
          </main>
        </ScrollArea>
