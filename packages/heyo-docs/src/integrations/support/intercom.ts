 ...
 *
 * Intercom boots Messenger with a public workspace ID and its asynchronous
 * widget loader. The ID is deliberately supplied outside the inline script.
 */
...
export function intercomBootstrapScript(): string {
  return `(function(){var d=document;var appId=d.currentScript&&d.currentScript.getAttribute("data-intercom-app-id");if(!appId){return;}var w=window;w.intercomSettings={app_id:appId};var ic=w.Intercom;if(typeof ic==="function"){ic("update",w.intercomSettings);return;}var i=function(){i.c(arguments);};i.q=[];i.c=function(args){i.q.push(args);};w.Intercom=i;var l=function(){var s=d.createElement("script");s.type="text/javascript";s.async=true;s.src=new URL(encodeURIComponent(appId),"https://widget.intercom.io/widget/").href;var x=d.getElementsByTagName("script")[0];x.parentNode.insertBefore(s,x);};if(d.readyState==="complete"){l();}else if(w.attachEvent){w.attachEvent("onload",l);}else{w.addEventListener("load",l,false);}})();`;
}
