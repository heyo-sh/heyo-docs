...
Framework integrations and the configuration reference are available in the [Heyo Docs documentation](https://heyo.sh).
...
`create-heyo-docs` includes them. Read the [configuration reference](https://heyo.sh/manage-website/configuration) for the full API.
